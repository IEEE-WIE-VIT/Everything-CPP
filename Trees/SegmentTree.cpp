...
/*
    A recursive segment tree implementation for range sum and point update queries
    Given 'left' and 'right' indices, it produces result of range [left, right).
...
class SegmentTree
{
    ...
    /* Produces result of [l, r) */
    int get(int l, int r)
    {
        return get(l, r, 0, 0, size);
    }

    /* Adds value 'v' at index 'l' */
