/*
The number of ways to divide an array into 2 groups such that
P1=product of all umbers in group 1
P2=product of all umbers in group 2
GCD(p1,p2)=1
using pragma for better optimization
*/
